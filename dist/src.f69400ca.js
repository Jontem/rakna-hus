...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"store/store.tsx":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  Store.prototype.render = function () {
    ...
    return this.props.children(this.state, function (state, callback) {
...
exports.Store = Store;
},{"react":"../node_modules/react/index.js"}],"store/index.ts":[function(require,module,exports) {
"use strict";
...
},{"./store":"store/store.tsx"}],"lib/get-number.ts":[function(require,module,exports) {
"use strict";
...
function getNumber(value) {
  ...
  for (var _i = 0, _a = value.toString(); _i < _a.length; _i++) {
    var char = _a[_i];
...
},{}],"components/number-input.tsx":[function(require,module,exports) {
"use strict";
...
var get_number_1 = require("../lib/get-number");
...
function NumberInput(props) {
  return React.createElement("input", __assign({}, props, {
    ...
    onChange: function onChange(e) {
      ...
      var parsed = get_number_1.getNumber(value);
      console.log(parsed);
...
},{"react":"../node_modules/react/index.js","../lib/get-number":"lib/get-number.ts"}],"components/index.ts":[function(require,module,exports) {
"use strict";
...
},{"./number-input":"components/number-input.tsx"}],"app/actions.ts":[function(require,module,exports) {
"use strict";
...
exports.setPantBrev = setPantBrev;
...
function View(_a) {
  ...
  var kontantinsats15 = state.price && state.price * 0.15;
  var kontantinsats25 = state.price && state.price * 0.25;
  ...
  return React.createElement("div", {
    ...
    className: "form-group"
  }, React.createElement("label", null, "Existerande pantbrev"), React.createElement(Components.NumberInput, {
    className: "form-control",
    value: state.pantbrev,
    onChange: function onChange(value) {
      dispatch(Actions.setPantBrev(value));
    }
  }))), React.createElement("h2", null, "Resultat"), React.createElement("form", null, React.createElement("div", {
    className: "form-group"
  }, React.createElement("label", null, "Kontantinsats"), React.createElement("input", {
    type: "text",
    readOnly: true,
    className: "form-control",
    ...
    className: "form-group"
  }, React.createElement("label", null, "Lagfart (1,5 % + 825kr fast avgift)"), React.createElement(Components.NumberInput, {
    readOnly: true,
    className: "form-control",
    value: lagfart,
    onChange: function onChange(value) {}
    ...
    className: "form-group"
  }, React.createElement("label", null, "Kostnader pantbrev (2 %)"), React.createElement(Components.NumberInput, {
    readOnly: true,
    className: "form-control",
    value: pantbrev,
    onChange: function onChange(value) {}
    ...
    className: "form-group"
  }, React.createElement("label", null, "Totalt kontanter"), React.createElement("input", {
    type: "text",
    readOnly: true,
    className: "form-control",
    value: (kontantinsats15 + lagfart + pantbrev).toLocaleString() + "(15%), " + (kontantinsats25 + lagfart + pantbrev).toLocaleString() + "(25%)",
    onChange: function onChange(value) {}
  }))));
}

exports.View = View;
},{"react":"../node_modules/react/index.js","../components":"components/index.ts","./actions":"app/actions.ts"}],"../node_modules/ts-exhaustive-check/lib-esm/index.js":[function(require,module,exports) {
"use strict";
 ...
 */
function exhaustiveCheck(check, throwError) {
...
},{}],"app/state.ts":[function(require,module,exports) {
"use strict";
...
var ts_exhaustive_check_1 = require("ts-exhaustive-check");
...
function reducer(state, action) {
  switch (action.type) {
    ...
    default:
      {
        ts_exhaustive_check_1.exhaustiveCheck(action);
        return state;
      }
  }
}
...
},{"ts-exhaustive-check":"../node_modules/ts-exhaustive-check/lib-esm/index.js"}],"app/index.ts":[function(require,module,exports) {
"use strict";
...
exports.initialState = state_1.initialState;

var actions_1 = require("./actions");

exports.Action = actions_1.Action;
},{"./view":"app/view.tsx","./state":"app/state.ts","./actions":"app/actions.ts"}],"index.tsx":[function(require,module,exports) {
"use strict";
...
ReactDOM.render(React.createElement(Store.Store, null, function (state, setState) {
  return React.createElement(App.View, {
    dispatch: function dispatch(action) {
      var prevState = state || App.initialState;
      var nextState = App.reducer(prevState, action);
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./store":"store/index.ts","./app":"app/index.ts"}],"../../../.nvm/versions/node/v8.9.2/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../.nvm/versions/node/v8.9.2/lib/node_modules/parcel/src/builtins/hmr-runtime.js","index.tsx"], null)
